...
const factoryData: factoryInfoType[] = [
  {
    ...
    warehouse_id: 1688,
    warehouse_name: '',
    area_name: 'Bull No. 1 Warehouse Inventory Area',
    parent_id: 0,
  ...
  },
  {
    ...
    warehouse_id: 1688,
    warehouse_name: '',
    area_name: 'Bull No. 1 Warehouse Picking Area',
    parent_id: 0,
  ...
  },
  {
    ...
    warehouse_id: 1688,
    warehouse_name: '',
    area_name: 'Bull No. 1 Warehouse Staging Area',
    parent_id: 0,
  ...
  },
  {
    ...
    warehouse_id: 1688,
    warehouse_name: '',
    area_name: 'Bull No. 1 Warehouse Receiving Area',
    parent_id: 0,
...
const shelfItemData:shelfItemInfoType[] = [
  {
    id: 441,
    warehouse_id: 1688,
    warehouse_name: 'Bull No. 1 Warehouse',
    warehouse_area_name: 'Bull No. 1 Warehouse Inventory Area',
  ...
  },
  {
    id: 441,
    warehouse_id: 1688,
    warehouse_name: 'Mengniu No. 1 Warehouse',
    warehouse_area_name: 'Mengniu No. 1 warehouse storage area',
    warehouse_area_property: 6,
  ...
  },
  {
    id: 447,
    warehouse_id: 1689,
    warehouse_name: 'Mengniu No. 2 Warehouse',
    warehouse_area_name: 'Mengniu No. 2 warehouse storage area',
    warehouse_area_property: 6,
  ...
  },
  {
    ...
    warehouse_id: 1688,
    warehouse_name: 'Mengniu No. 1 Warehouse',
    warehouse_area_name: 'Mengniu No. 1 warehouse picking area',
...
const productData:productInfoType[] = [
  {
    ...
    location_name: 'mn-1-1-3-10',
    spu_code: 'candy',
    spu_name: 'Strong milk candy',
    sku_id: 767,
    sku_code: 'candy2',
    sku_name: 'Packing toffee',
    qty: 200,
    qty_available: 200,
    qty_locked: 0,
    qty_frozen: 0,
    goods_owner_name: 'null',
    series_number: '',
  ...
  },
  {
    ...
    spu_code: 'mnmilk',
    spu_name: 'Mengniu milk',
    sku_id: 766,
    sku_code: 'mnmilk1',
    sku_name: 'Mengniu small bottle of milk',
    qty: 50,
    qty_available: 0,
    qty_locked: 50,
    qty_frozen: 0,
  ...
  },
  {
    ...
    sku_id: 765,
    sku_code: 'mnmilk2',
    sku_name: 'Mengniu big bottle of milk',
    qty: 300,
    qty_available: 300,
    qty_locked: 0,
    qty_frozen: 0,
...
const warehouseData:warehouseInfoType = {
  ...
  warehouse_name: 'Mengniu No. 1 Warehouse',
  city: 'fuzhou',
  address: 'Cangshan District, Fuzhou City',
