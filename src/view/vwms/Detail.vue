  ...
  <div class="warehouse-info VWms-card">
      ...
      <div v-if="props.presentData?.type === 'warehouse'">
        ...
        <div class="data-grid">
          <div class="column-center data-container">
            <p class="data-label">Number of reservoir areas</p>
            <p class="data-number">{{ props.presentData?.factory_number }}</p>
          </div>
          <div class="column-center data-container">
            <p class="data-label">Inventory</p>
    ...
    <Transition name="slide-fade">
      <div v-show="props.presentData?.type === 'factory'">
        ...
        <div class="data-grid">
          <div class="column-center data-container">
            <p class="data-label">Total number of shelves</p>
            <p class="data-number">{{ props.presentData?.shelf_number }}</p>
          </div>
          <div class="column-center data-container">
            <p class="data-label">Total number of warehouses</p>
            <p class="data-number">{{ props.presentData?.shelf_item_number }}</p>
          </div>
          <div class="column-center data-container">
            <p class="data-label">Remaining locations</p>
            <p class="data-number">{{ props.presentData?.surplus_number }}</p>
          </div>
          <div class="column-center data-container">
            <p class="data-label">Total number of goods</p>
    ...
    <Transition name="slide-fade">
      <div v-show="props.presentData?.type === 'shelf'">
        <div class="flex-center-between">
          ...
          <p><span class="em">Shelf specifications: </span>{{ props.presentData?.layer }} * {{ props.presentData?.column }}</p>
        </div>
        <v-divider></v-divider>
        <div class="data-grid">
          <div class="column-center data-container">
            <p class="data-label">Idle location</p>
            <p class="data-number">{{ props.presentData?.surplus_number }}</p>
          </div>
          <div class="column-center data-container">
            <p class="data-label">Total number of goods</p>
    ...
    <Transition name="slide-fade">
      <div v-show="props.presentData?.type === 'shelfItem'">
        <div class="header">
          <p class="main-title">{{ props.presentData?.tag_number }}No. storage location</p>
        </div>
        <div class="text-grid">
          <p>Layer number:</p>
        ...
        <v-divider></v-divider>
        <div>
          <div v-if="props.presentData?.product?.length === 0">Empty location</div>
          <div v-else class="product-info-container">
            ...
            >
              ...
              <vxe-column field="spu_name" title="Item name"></vxe-column>
              <vxe-column field="sku_name" title="Specification name"></vxe-column>
              <vxe-column field="qty" title="Quantity"></vxe-column>
            </vxe-table>
          </div>
        </div>
      </div>
